package eu.kryocloud.node.config.setup;
...
public final class WrapperSetupConfig extends Config {
    ...
    @Comment("Node host address the wrapper connects to")
    private String nodeHost = "127.0.0.1";

    @Comment("Node protocol port the wrapper connects to")
    ...
    public WrapperSetupConfig(Path path) {
        super(path);
    }
